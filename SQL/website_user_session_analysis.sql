...
/*
Pulling monthly trends for gsearch sessions and orders to showcase the growth. 
*/ 
...
/*
Finding out similar monthly trend for Gsearch, but this time splitting out nonbrand 
...
/*
Pulling monthly sessions and orders split by device type.
*/ 
...
/*
Pulling monthly trends for Gsearch, alongside monthly trends for each of our other channels.
*/ 
...
/*
Estimating the revenue for the gsearch lander test.
*/ 
...
-- next restricting to home or lander-1
...
/*
For the landing page test, showing a full conversion funnel 
...
/*
Quantify the impact of billing test. Analyzing the lift generated 
from the test, in terms of revenue per billing page session, and then pulling the number 
