...
/*
Showing volume growth. Pulling overall session and order volume, 
trended by quarter.
*/ 
...
/*
Showcasing efficiency improvements and quarterly figures 
since the launch, for session-to-order conversion rate, revenue per order, and revenue per session. 
*/
...
/*
Growth in specific channels by pulling quarterly view of orders 
...
/*
Showing the overall session-to-order conversion rate trends for the above mentioned same channels, 
by quarter.
*/
...
/*
Pulling monthly trends for revenue and margin by product, along with total sales and revenue.
*/
...
/*
Pulling monthly sessions to the '/products' page, and % of those sessions clicking through another page has changed 
...
/*
Pull sales data since December 05, 2014, and show how well each product cross-sells from one another?
*/
